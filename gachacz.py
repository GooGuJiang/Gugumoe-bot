...
class Gacha_cz(object):
    ...
    @staticmethod
    def pic2b64(im,id=000):
        # im是Image对象，把Image图片转成base64
        #bio = BytesIO()
        finame = "./tmp/gugu"+str(id)
        im.save(finame+".png", format='PNG')
        #im = Image.open(finame+".png")
        #im.save(finame+".webp", "WEBP")
...
def gacha_info_cz(pool = DEFAULT_POOL):
    # UP角色信息
